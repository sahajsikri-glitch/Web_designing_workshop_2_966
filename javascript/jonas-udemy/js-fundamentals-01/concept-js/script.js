...
const agez = 23;
// agez >= 18 ? console.log('I like to drink wine 🍷') : console.log('I like to drink water 💧');

//way - 1
const drink = agez >= 18 ? "wine 🍷" : "water 💧";
console.log(drink);
...
//way - 3  (best one)
console.log(`I like to drink ${agez >= 18 ? "wine 🍷" : "water 💧"}`);
